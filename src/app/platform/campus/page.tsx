            ...
            <main className="flex-grow pt-[68px]"> {/* Offset for fixed Navbar */}
                ...
                <section className="py-24 bg-white">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-20">
                            <h2 className="text-4xl md:text-5xl font-serif text-[#111110] mb-6">Everything an institution needs</h2>
                ...
                <section className="py-24 bg-slate-50 border-t border-slate-200">
                    <div className="max-w-4xl mx-auto px-6 text-center">
                        <h2 className="text-3xl font-serif text-[#111110] mb-6">Want to see how it integrates?</h2>
