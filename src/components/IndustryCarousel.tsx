...
const Card = ({ image, label, href }: { image: string; label: string; href: string }) => (
    ...
    >
        ...
        />
        <p className="absolute top-5 left-5 text-white text-[15px] font-semibold leading-tight drop-shadow-sm">
            {label}
        </p>
    </Link>
);
...
const cards = [
    {
        ...
        image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=600&q=85",
        href: "/platform/features/smart-learning-management"
    },
    {
        label: "Learner Progress",
        image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=85",
        href: "/platform/features/intelligent-analytics"
    },
    {
        label: "AI Assessments",
        image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=600&q=85",
        href: "/platform/features/ai-features-ai-agents"
    },
    {
        label: "Live Classrooms",
        image: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=600&q=85",
        href: "/platform/features/live-sessions"
    },
    {
        label: "Certifications",
        image: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&w=600&q=85",
        href: "/platform/features/certificates-certificate-designer"
    },
    {
        label: "Integrations",
        image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=600&q=85",
        href: "/platform/features/integrations"
    },
    {
        label: "White-label",
        image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&w=600&q=85",
        href: "/solutions/white-labelled-solution"
    },
];
...
const IndustryCarousel = () => {
    ...
    return (
        <section className="py-24 bg-white overflow-hidden">
            <div className="max-w-[1440px] mx-auto px-6 mb-10 flex items-end justify-between">
            ...
            {/* Scrollable row — no-scrollbar hides the bar, scroll action still works */}
            <div
                ref={scrollRef}
                className="flex gap-4 overflow-x-auto px-6 snap-x snap-mandatory no-scrollbar"
            >
                {cards.map((card) => (
