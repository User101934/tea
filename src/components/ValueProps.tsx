                    ...
                    {props.map((prop, index) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex flex-col">
                                ...
                                <Link href={prop.href} className="inline-flex items-center gap-2 text-[14px] font-bold text-indigo-600 font-sans group/link">
                                    <span className="border-b border-indigo-100 group-hover/link:border-indigo-600 transition-colors">Learn more</span>
