  ...
  .hero-headline {
    ...
    letter-spacing: -0.015em;
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
        ...
        {/* Headline + CTAs */}
        <div className="max-w-[920px] mx-auto text-center mb-12 md:mb-24 flex flex-col items-center">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8">
              <div className="bg-white/80 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/20">
                <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-indigo-600 mb-1">
                  Collaborative
                </p>
                <h3 className="text-base text-[#111110]">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <div className="bg-white/90 backdrop-blur-xl px-5 py-3.5 rounded-2xl border border-slate-200">
                ...
                <h3 className="text-[17px] leading-tight text-[#111110]">
